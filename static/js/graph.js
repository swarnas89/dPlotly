...
let cy = cytoscape({
  ...
  cy.add([
      ...
      { group: 'nodes',data: { id: 'n5',label:'Title' }, position: { x: 191, y: 62 } },
      { group: 'nodes',data: { id: 'n6' }, position: { x: 66, y: 83 } },
      { group: 'edges',data: { id: 'e0', source: 'n1', target: 'n2', label: 'abstract' } },
      { group: 'edges',data: { id: 'e1', source: 'n2', target: 'n3', label: 'authors' } },
      { group: 'edges',data: { id: 'e2', source: 'n1', target: 'n6', label: 'venue' } },
      { group: 'edges',data: { id: 'e3', source: 'n1', target: 'n3', label: 'year' } },
